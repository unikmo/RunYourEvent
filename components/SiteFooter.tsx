        ...
        <div className="grid gap-10 md:grid-cols-[1.3fr_.7fr_.7fr]">
          <div>
            <a href="/" className="inline-flex items-center gap-3" aria-label="RunYourEvent Startseite">
              <span className="grid h-8 w-8 place-items-center rounded-xl bg-white text-sm font-black text-[#25823d]">RY</span>
              <span className="text-lg font-black tracking-[-0.04em]">RunYourEvent</span>
            </a>
            <p className="mt-5 max-w-sm text-sm leading-6 text-white/58">Spieltage strukturieren, Aufgaben aufteilen und Helfer für klare 2-Stunden-Schichten finden.</p>
